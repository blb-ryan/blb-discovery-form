...
export const sections = [
  ...
  // ── Section 11: Brand Personality ────────────────────────────────
  {
    ...
    intro: "This is where we start to feel your brand, not just understand it.",
    time: 'About 2 minutes',
    questions: [
      {
        id: 'personality_masculine_feminine',
      ...
      {
        id: 'personality_neutral_colorful',
        text: 'Neutral — Colorful',
        type: 'spectrum',
        leftLabel: 'Neutral',
        rightLabel: 'Colorful',
        hideIDK: true,
      ...
      {
        id: 'personality_simple_intricate',
        text: 'Simple — Intricate',
        type: 'spectrum',
        leftLabel: 'Simple',
      ...
      {
        id: 'personality_approachable_exclusive',
        text: 'Approachable — Exclusive',
        type: 'spectrum',
      ...
      {
        id: 'personality_conservative_extravagant',
        text: 'Conservative — Extravagant',
        type: 'spectrum',
      ...
      {
        id: 'personality_necessity_luxury',
        text: 'Necessity — Luxury',
        type: 'spectrum',
        leftLabel: 'Necessity',
        rightLabel: 'Luxury',
        hideIDK: true,
      ...
      {
        id: 'personality_professional_casual',
        text: 'Professional — Casual',
        type: 'spectrum',
      ...
      {
        id: 'personality_safe_disruptive',
        text: 'Safe — Disruptive',
        type: 'spectrum',
        leftLabel: 'Safe',
      ...
      {
        id: 'personality_vibe',
        text: "How would you describe your brand as a vibe? Not a tagline. A feeling. If someone walked into a room and your brand was already there, what would the room feel like?",
        type: 'textarea',
        placeholder: 'e.g., A calm, modern hotel lobby with warm lighting and a curated playlist you actually want to Shazam.',
      },
      {
        id: 'personality_space',
        text: "If your brand had a physical location (a store, a studio, a lobby), what would it look like? What would people notice first?",
        type: 'textarea',
        placeholder: 'e.g., Floor-to-ceiling windows, concrete floors, warm wood shelves, one perfect plant.',
      },
    ],
  },
  ...
  // ── Section 12: Visual Direction ──────────────────────────────────
  {
    ...
    questions: [
      {
        id: 'visual_logo_story',
        text: "If you have a current logo, what's the story behind it? How did it come to be?",
        type: 'textarea',
        placeholder: "e.g., Our founder sketched it on a napkin in 2015. It's a stylized mountain.",
        gate: (answers) => answers.brand_status === 'Existing Brand',
      },
      {
        id: 'visual_identity_likes',
        text: "What do you like about your current visual identity? Colors, type, photography, anything.",
        type: 'textarea',
        placeholder: "e.g., Our color palette feels right. The photography style is strong.",
        gate: (answers) => answers.brand_status === 'Existing Brand',
      },
      {
        id: 'visual_identity_dislikes',
        text: "What do you dislike about your current visual identity? What feels off or outdated?",
        type: 'textarea',
        placeholder: "e.g., The logo feels dated. Our website doesn't match the quality of our work.",
        gate: (answers) => answers.brand_status === 'Existing Brand',
      },
      {
        id: 'visual_brand_admiration',
        ...
        type: 'textarea',
        placeholder: "e.g., Aesop (clean, editorial, intentional), Patagonia (honest, rugged, purposeful)",
      },
      {
        id: 'visual_colors',
        text: "What colors are you drawn to? Are these product colors, brand colors, or both?",
        type: 'textarea',
        placeholder: "e.g., Deep navy, warm cream, and a pop of terracotta. These feel like brand colors to us.",
      },
      {
        id: 'visual_nouns_verbs',
        text: "Give us 5 nouns and 5 verbs that describe the world of your brand. Think physical and emotional.",
        subtitle: "Example nouns: stone, ritual, harbor, edge. Example verbs: refine, anchor, strip, warm.",
        type: 'textarea',
        placeholder: "Nouns: ...\nVerbs: ...",
      },
      {
        id: 'visual_style_direction',
        text: "Is there a visual style, era, or aesthetic you want to channel or avoid?",
        type: 'textarea',
        placeholder: "e.g., Channel: mid-century modern meets Scandinavian minimalism. Avoid: anything that feels corporate or clip-art.",
      },
      {
        id: 'visual_must_haves',
        text: "Are there any visual must-haves or must-nots we should know about? Sacred colors, fonts you hate, imagery that's off-limits, things the board will reject on sight.",
        type: 'textarea',
        placeholder: "e.g., Must-have: our signature green. Must-not: no stock photography of people shaking hands.",
      },
    ],
  },
